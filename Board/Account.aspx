    ...
    <asp:Table runat="server" Width="360px" HorizontalAlign="Center">
        <asp:TableRow HorizontalAlign="Right">
            <asp:TableCell>
                ...
                &nbsp;
                <asp:LinkButton ID="btnCanel" runat="server" Width="100px" CssClass="btn btn-primary">뒤로가기</asp:LinkButton>
                &nbsp;
                <asp:Button ID="btnPassword" runat="server" Width="100px" CssClass="btn btn-primary" Text="Button" />
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
