<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Account.aspx.cs" Inherits="Board.Account" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table ID="tblAccount" runat="server" Width="360px" HorizontalAlign="Center" CssClass="table table-bordered table-hover table-stripe">
        ...
        <asp:TableRow BackColor="LightGray" Height="20%">
            <asp:TableCell>새 비밀번호</asp:TableCell>
            <asp:TableCell>
    ...
    <asp:Table runat="server" Width="360px" HorizontalAlign="Center">
        <asp:TableRow HorizontalAlign="Right">
            <asp:TableCell>
                <asp:LinkButton ID="btnConfirm" runat="server" Width="100px" CssClass="btn btn-primary" OnClick="btnConfirm_Click">수정</asp:LinkButton>
                &nbsp;
                <asp:Button ID="btnPassword" runat="server" Width="130px" CssClass="btn btn-primary" OnClick="btnPassword_Click" Text="비밀번호 수정" />
                &nbsp;
                <asp:Button ID="btnPwCancel" runat="server" Width="100px" CssClass="btn btn-primary" OnClick="btnPwCancel_Click" Text="취소" />               
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
